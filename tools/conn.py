...
def conn_ooop():
    ...
    try:
        #o = OOOP(user='admin',pwd='admin',dbname='oerp6_elearning',uri='http://localhost',port=8069,protocol='xmlrpc')
        #o = OOOP(user='admin',pwd='admin',dbname='oerp6_elearning',uri='localhost',port=8071,protocol='pyro')
